	...
	<%@ include file="/WEB-INF/views/inc/topbar.jsp" %>
			...
			<body>
				<div class="container">
					...
					<!-- 가입 시작 -->
					<form class="form-horizontal" id="myform" action="${pageContext.request.contextPath }/member/join_ok.do"
					method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="user_pw" class="col-md-2">비빌번호*</label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label for="user_pw_re" class="col-md-2">비빌번호 확인*</label>
							<div class="col-md-10">
					...
					<div class="form-group">
						...
						<div class="col-md-10 clearfix">
							...
							style='width: 120px; margin-rihgt: 5px'> 
