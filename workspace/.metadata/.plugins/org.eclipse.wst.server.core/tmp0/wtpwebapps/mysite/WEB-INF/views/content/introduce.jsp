	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 text-center">
				<img src="${pageContext.request.contextPath}/asset/img/html5.jpg"
					class="img-circle" width="240" height="240" />
				<h2>HTML5</h2>
			...
			<div class="col-md-4 text-center">
				<img src="${pageContext.request.contextPath}/asset/img/css3.jpg"
					class="img-circle" width="240" height="240" />
				<h2>CSS3</h2>
			...
			<div class="col-md-4 text-center">
				<img src="${pageContext.request.contextPath}/asset/img/bs3.jpg"
					class="img-circle" width="240" height="240" />
				<h2>Bootstrap3</h2>
		...
		<div class="row featurette">
			...
			<div class="col-md-5">
				<img class="img-thumbnail img-responsive"
					src="${pageContext.request.contextPath}/asset/img/img01.jpg"
		...
		<div class="row featurette">
			<div class="col-md-5">
				<img class="img-thumbnail img-responsive"
					src="${pageContext.request.contextPath}/asset/img/img02.jpg"
					width="500" height="500" />
			</div>
			<div class="col-md-7">
				<h2 class="featurette-heading">
		...
		<div class="row featurette">
			...
			<div class="col-md-5">
				<img class="img-thumbnail img-responsive"
					src="${pageContext.request.contextPath}/asset/img/img03.jpg"
					width="500" height="500" />
			</div>
		</div>
	</div>
