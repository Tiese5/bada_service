...
<%@ include file="/WEB-INF/inc/sidebar.jsp" %>
            ...
            <div class="test col-sm-9 col-md-10 main-content">
                ...
                <div class="image col-md-9 clearfix">
                    ...
                    <ul class="size">
                        <li><h2><strong>${readItem.item_title}</strong></h2></li>
                        <li><h3>등록일: ${readItem.reg_date}</h3></li>
                        <li><h3>판매자: <a href="${pageContext.request.contextPath}/message_send.do?id=${readItem.member_id}" id="nameid"> ${readItem.memberName}</a></h3></li>
                        <li><h3><strong class="color">${readItem.price}</strong>원</h3></li>
                   </ul>
                   		<a href="${pageContext.request.contextPath}/buy.do?id=${readItem.id}" class="btns btn btn-primary" id="buy">구매하기</a>
                        <a href="${pageContext.request.contextPath}/cart.do?id=${readItem.id}" class="btns btn btn-warning" id="cart">장바구니</a>
             ${shop.item_title}
                </div>
