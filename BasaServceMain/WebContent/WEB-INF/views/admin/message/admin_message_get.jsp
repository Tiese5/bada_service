                    ...
                    <table class="table table-hover">
                        <thead style="background-color : #eee;">
                            <tr>
                                ...
                                <th class="text-center" width="20%">받은날짜</th>
                            </tr>
                        </thead>
                        <tbody>          
                 <c:choose>
							...
							<ul class="pagination">
								...
								<c:choose>
									<c:when test="${pageHelper.prevPage > 0}">
										...
										<c:url var="prevUrl" value="/admin_message_get.do">											
								...
								<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" step="1">
									...
									<c:url var="pageUrl" value="/admin_message_get.do">										
								...
								<c:choose>
									<c:when test="${pageHelper.nextPage > 0}">
										...
										<c:url var="nextUrl" value="/admin_message_get.do">											
