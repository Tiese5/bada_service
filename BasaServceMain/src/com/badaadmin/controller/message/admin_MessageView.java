 ...
 */
@WebServlet("/admin_message_view.do")
public class admin_MessageView extends BaseController {
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			readMessage = messageService.selectAdminMessage(messenger);
		} catch (Exception e) {
		...
		return "admin/message/admin_message_view";
	}
