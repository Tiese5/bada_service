 ...
 */
@WebServlet("/admin_message_delete.do")
public class admin_message_delete extends BaseController {
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			messageService.deleteAdminMessage(messenger);
		} catch (Exception e) {
			sqlSession.close();
		...
		String url = "%s/admin_message_get.do";
