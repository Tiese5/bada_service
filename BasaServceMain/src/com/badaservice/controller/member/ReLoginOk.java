...
@WebServlet("/member/Relogin_ok.do")
public class ReLoginOk extends BaseController {
	...
	private static final long serialVersionUID = 6385861797102763625L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String profileImg = loginInfo.getProfile_img();
		if (profileImg != null) {
			String profileThumbnail =  
				UploadHelper.getInstance().createThumbnail(profileImg, 40, 40, true);
		...
		web.redirect(web.getRootPath()+"/member/edit_pw.do", null);
		return null;
	}
